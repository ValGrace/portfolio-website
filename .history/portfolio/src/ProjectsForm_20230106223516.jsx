...
const ProjectsForm = () => {
  ...
  const selectedPhoto = (event) => {
    ...
    return (
        <form method="post" action="/newproject" encType="multipart/form-data" id="project-form">
          <div className="imageContainer">
          <img src="" className="Image" alt="profile" ref={photoRef} />
          <label htmlFor="inputFile">
          <BsFillCameraFill color='rgb(250, 0, 104)' size='2em' opacity='1.0' />  
          ...
          <input type="submit" onClick={newProject} value="add project" id="project-btn"/>
        </form>
    )
}

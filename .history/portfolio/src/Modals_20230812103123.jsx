    ...
    return (
        <>
            ...
            <Space>
             <Carousel>
                <div>
                     <img src="" style={bgStyle} alt="app cover"/>  
                </div>
                <div>
                     <img src="" style={bgStyle} alt="app cover"/>  
                </div>
            ...
            <Image
            preview={false}
            src="https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png?x-oss-process=image/,r_50,s_50/quality,q_1/resize,m_mfit,h_200,w_200"
             width={400}
          />
          </Space>
            <Space size={20}>

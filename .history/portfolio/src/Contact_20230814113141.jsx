...
const Contact = () => {
    ...
    return (
        ...
        <form onSubmit={sendEmail} className="contact-form">
            ...
            <Space size={30}>
            <a href="https://www.linkedin.com/in/grace-anyango873/" target="blank"><LinkedinOutlined style={iconStyle} title="linkedin profile"/></a>
            <a href="https://github.com/ValGrace" target="blank"><GithubOutlined style={iconStyle} title="github profile"/></a>
            </Space>
        </form>

...
const SLIDES = [
    ...
    title: "Overview",
    body: "Designed to be light-weight and cross-platform",
    bullets: [
      "A command interceptor that captures terminal commands",
  ...
  },
  {
    badge: "Command Tracker",
    title: "Features",
    body: "Manage your terminal sessions",
    bullets: [
      "Record commands and keep a history",
  ...
  
  {
    badge: "Command tracker",
    title: "Benefits",
    body: "Turn a simple log of commands into a productivity asset.",
    bullets: [

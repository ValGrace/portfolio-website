...
const socialLinks = [
    {icon: Mail, label: "Email", url: "mailto:gracevalerie1@gmail.com", color: "from-red-500 to-orange-500"},
    {icon: Linkedin, label: "LinkedIn", url: "https://www.linkedin.com/in/grace-anyango873/", color: "from-blue-500 to-blue-600"},
    {icon: Github, label: "GitHub", url: "https://github.com/ValGrace", color: "from-gray-600 to-gray-800" },
    {icon: Twitter, label: "Twitter", url: "https://twitter.com/Grace_Anyango7", color: "from-sky-400 to-blue-500"},
]

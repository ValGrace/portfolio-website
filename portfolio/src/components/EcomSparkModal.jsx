...
const SLIDES = [
    ...
    title: "Overview",
    body: "Pyspark based ecommerce data pipeline",
    bullets: [
      "Transforms raw business data into structured, analysis-ready output",
      "Cleans and standardizes records",
      "Ingests customer, order, order-items and return data",
    ],
  },
  {
    badge: "Ecommerce Spark",
    title: "Features",
    body: "Processing multiple ecommerce datasets",
    bullets: [
      "Ingests and processes datasets from CSV files",
      "Cleans and casts records to improve data quality",
  ...
  
  {
    badge: "Ecommerce Spark",
    title: "Benefits",
    body: "Analyze revenue, refunds and customer behavior more effectively",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      "Pyspark (transformations and processing)",
      "Python (programming)",
